function [sol, q1, bubble1, shuttle1, ...
    q2, bubble2, shuttle2] = runEulerCodeShuttleDual(nx,airgunPressure,airgunLength,airgunPortArea,airgunDepth)
    % Initialize airgun
%     d = DiscrAirgun(nx,3,airgunPressure,airgunLength, ...
%         airgunPortArea,airgunDepth);
    dRevert = DiscrAirgunShuttleMulti(nx,3,airgunPressure,airgunLength, ...
        airgunPortArea,airgunDepth,true);
    dNew = DiscrAirgunShuttleMulti(nx,3,airgunPressure,airgunLength, ...

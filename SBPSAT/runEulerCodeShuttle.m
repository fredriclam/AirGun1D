function [sol, q1, bubble1, shuttle1, ...
    q2, bubble2, shuttle2] = runEulerCodeShuttle(nx,airgunPressure,airgunLength,airgunPortArea,airgunDepth)
    % Initialize airgun
%     d = DiscrAirgun(nx,3,airgunPressure,airgunLength, ...
%         airgunPortArea,airgunDepth);
    dRevert = DiscrAirgunShuttleMulti(nx,4,airgunPressure,airgunLength, ...
        airgunPortArea,airgunDepth,true);
    dNew = DiscrAirgunShuttleMulti(nx,4,airgunPressure,airgunLength, ...
        airgunPortArea,airgunDepth,false);
...
%     y0 = [q0; bubble0; shuttle0; q0; bubble0; shuttle0];
    ...
    tspan = [0; 0.010]; % Simulation tmin to tmax (specify here)
